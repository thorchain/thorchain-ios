...
extension Midgard {
    ...
    /// Represents a Midgard inbound address object containing details of vault as returned by `/v2/thorchain/inbound_addresses`
...
extension Midgard {
    ...
    public enum PoolStatus : String, Decodable {
        case available, staged, suspended
    }

    /// Pool data returned from Midgard `/v2/pools` and `/v2/pool/{asset}`
    /// https://testnet.midgard.thorchain.info/v2/doc#operation/GetPools
    public struct Pool : MidgardAPIResponse, MidgardAPIResponseAsArray {
        ...
        /// The total volume of swaps in the last 24h to and from Rune denoted in Rune. (Int64 as String)
...
extension Midgard {
    ...
    /// Midgard `/v2/health` response
    /// https://testnet.midgard.thorchain.info/v2/doc#operation/GetHealth
    public struct HealthInfo : MidgardAPIResponse {
...
extension Midgard {
    ...
    public enum PoolPeriod : String {
        case oneHour = "1h", oneDay = "24h", oneWeek = "7d", thirtyDays = "30d", ninetyDays = "90d", oneYear = "365d", all = "all"
    }
    
    /// Midgard `/v2/pool/{asset}/stats` response
    /// https://testnet.midgard.thorchain.info/v2/doc#operation/GetPoolStats
    public struct PoolStatistics : MidgardAPIResponse {
...
//}
extension Midgard {
    public enum HistoryInterval : String {
        case fiveMinutes = "5min" , hour, day, week, month, quarter, year
    }
}

extension Midgard {
    /// Depth and Price History from `/v2/history/depths/{pool}`
    /// https://testnet.midgard.thorchain.info/v2/doc#operation/GetDepthHistory
    public struct PriceDepthHistory : MidgardAPIResponse {
...
extension Midgard {
    ...
    /// https://testnet.midgard.thorchain.info/v2/doc#operation/GetEarningsHistory
    public struct EarningsHistory : MidgardAPIResponse {
...
extension Midgard {
    ...
    /// Swaps History from Midgard `/v2/history/swaps`
    /// https://testnet.midgard.thorchain.info/v2/doc#operation/GetSwapHistory
    public struct SwapsHistory : MidgardAPIResponse {
...
extension Midgard {
    ...
    /// Liquidity Changes History from Midgard `/v2/history/liquidity_changes`
    /// https://testnet.midgard.thorchain.info/v2/doc#operation/GetLiquidityHistory
    public struct LiquidityHistory : MidgardAPIResponse {
...
extension Midgard {
    /// Nodes List from `/v2/nodes`
    /// https://testnet.midgard.thorchain.info/v2/doc#operation/GetNodes
    public struct Node : MidgardAPIResponseAsArray {
...
//}
extension Midgard {
    /// Nodes List from `/v2/network`
    /// https://testnet.midgard.thorchain.info/v2/doc#operation/GetNetworkData
    public struct NetworkData : MidgardAPIResponse {
        /// Bond Metrics
...
extension Midgard {
    ...
    /// Actions List from Midgard `/v2/actions` API
    /// https://testnet.midgard.thorchain.info/v2/doc#operation/GetActions
    public struct ActionsList : MidgardAPIResponse {
...
extension Midgard {
    /// Midgard Members from `/v2/members` API
    /// https://testnet.midgard.thorchain.info/v2/doc#operation/GetMembersAdresses
...
//}
extension Midgard {
    /// Midgard Member Detail from Midgard `/v2/member/{address}` API
    /// https://testnet.midgard.thorchain.info/v2/doc#operation/GetMemberDetail
    public struct MemberDetail : MidgardAPIResponse {
...
extension Midgard {
    ...
    /// Global Stats from Midgard `/v2/stats` API}
    /// https://testnet.midgard.thorchain.info/v2/doc#operation/GetStats
    public struct GlobalStats : MidgardAPIResponse {
...
extension Thorchain {
    ...
    /// Thorchain constants from Midgard `/v2/thorchain/constants` API
    /// https://testnet.midgard.thorchain.info/v2/doc#operation/GetProxiedInboundAddresses
    public struct Constants : MidgardAPIResponse {
...
extension Thorchain {
    ...
    /// Thorchain last block information from Midgard `/v2/thorchain/lastblock` API
    /// https://testnet.midgard.thorchain.info/v2/doc#operation/GetProxiedLastblock
    public struct LastBlock : MidgardAPIResponseAsArray {
        public let chain : String
...
extension Thorchain {
    ...
    /// Queue endpoint from Thorchain Midgard `/v2/thorchain/queue` API
    /// https://testnet.midgard.thorchain.info/v2/doc#operation/GetProxiedQueue
    public struct Queue : MidgardAPIResponse {
        public let swap : Int
